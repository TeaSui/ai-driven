...
/**
 * Result produced by a {@link WorkflowStep} execution.
 * Carries output data that subsequent steps can consume via {@link WorkflowState}.
 */
public record WorkflowStepResult(
    ...
    /** Creates a skipped result (step was intentionally bypassed). */
